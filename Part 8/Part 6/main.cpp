...
void onFrame() {
	...
	{
		FillCircle(RANDFP * width, RANDFP * height, RANDFP * 10, RANDFP * 10, color(rand() & 0xff, rand() & 0xff, rand() & 0xff));
	}
}
void ProcessInput()
{
...
void MakeSurface(HWND hwnd) {
	...
	Pressing = new bool[0x100];
	bool b = false;
	FillArray((byte*)Pressing, (byte*)(Pressing + 0x100), sizeof(bool), sizeof(bool), (byte*)&b);
}
...
//we have to make a faster, safer method
